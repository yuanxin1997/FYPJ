var app = angular.module('lcafe', ['ionic', 'starter.controllers', 'starter.services', 'ngCordova', 'ion-datetime-picker', 'ion-floating-menu', 'angular-md5', 'jett.ionic.content.banner', 'angularMoment', 'ja.qr', 'star-rating'])
