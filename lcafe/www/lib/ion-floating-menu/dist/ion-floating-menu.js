...
(function() {
  ...
  function ionFloatingButtonCtrl($scope) {
    $scope.buttonColor = $scope.buttonColor || '#ef473a';
    $scope.icon = $scope.icon || 'ion-ios-color-wand';
  ...
  function ionFloatingMenuCtrl($scope, $rootScope, $ionicBackdropIon) {
    ...
    var menuColor = $scope.menuColor || '#ef473a';
    var menuIcon = $scope.menuIcon || 'ion-ios-color-wand';
    var menuIconColor = $scope.menuIconColor || '#fff';
    var menuOpenColor = $scope.menuOpenColor || '#ef473a';
    var menuOpenIcon = $scope.menuOpenIcon || 'ion-ios-color-wand';
