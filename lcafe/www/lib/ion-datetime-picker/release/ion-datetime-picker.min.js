    ...
    return {
      ...
      controller: ["$scope", "$ionicPopup", "$ionicPickerI18n", "$timeout", function(e, t, n, i) {
        ...
        e.showPopup = function() {
          ...
          e.year = e.dateEnabled ? t.getFullYear() : 0, e.month = e.dateEnabled ? t.getMonth() : 0, e.day = e.dateEnabled ? t.getDate() : 0, e.hour = e.timeEnabled ? t.getHours() : 0, e.minute = e.timeEnabled ? t.getMinutes() : 0, e.second = e.secondsEnabled ? t.getSeconds() : 0, l()
        };
        var l = function() {
            a();
            var t = new Date(e.year, e.month, e.day, e.hour, e.minute, e.second);
        ...
        e.changeBy = function(t, n) {
          if (+t) {
            ...
            e[n] += +t, "month" !== n && "year" !== n || (e.day = Math.min(e.day, s(e.year, e.month))), l()
          }
        }, e.change = function(t) {
          var n = e.bind[t];
          n && "meridiem" === t ? (n = n.toUpperCase(), "AM" === n && "PM" === e.meridiem ? e.hour -= 12 : "PM" === n && "AM" === e.meridiem && (e.hour += 12), l()) : (+n || 0 === +n) && (e[t] = +n, "month" !== t && "year" !== t || (e.day = Math.min(e.day, s(e.year, e.month))), l())
          ...
          for (var l = !0, s = 0; s < a.length; s++) {
            ...
            if (r.after) {
              var u = c(r.after);
              r.inclusive ? (l = i >= u, !l && n && o(u, 0)) : (l = i > u, !l && n && o(u, 1))
            } else if (r.before) {
              var m = c(r.after);
              r.inclusive ? (l = i <= m, !l && n && o(m, 0)) : (l = i < m, !l && n && o(m, -1))
            } else if (r.between) {
              var b = c(r.between.initial),
                h = c(r.between["final"]);
              r.inclusive ? (l = i >= b && i <= h, !l && n && (i < b && o(b, 0), i > h && o(h, 0))) : (l = i > b && i < h, !l && n && (i <= b && o(b, 1), i >= h && o(h, -1)))
            } else if (r.outside) {
              var b = c(r.outside.initial),
                h = c(r.outside["final"]);
              if (r.inclusive) {
                if (l = i <= b || i >= h, !l && n) {
                  var v = d.getDateWithoutTime();
                  v <= b && o(h, 0), v >= h && o(b, 0)
                }
              } else if (l = i < b || i > h, !l && n) {
                var v = d.getDateWithoutTime();
                v < b && o(h, 1), v > h && o(b, -1)
              }
            }
